...
function AddSentenceContent({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError("Network error adding sentence");
    } finally {
      setSubmitting(false);
    }
  };
      ...
      <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 font-medium">
                {mediaType === "book"
                  ? `To Book "${mediaName}" (Page ${pageNo})`
                  : `To ${mediaType === "song" ? "Song" : "Movie"} "${mediaName}"`}
              </p>
            </div>
          </div>
          <button
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={4}
              required
              placeholder="e.g. He had won the victory over himself."
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={2}
              placeholder="e.g. Signifies overcoming inner conflict and yielding to party dogma."
              ...
              <div className="p-4 rounded-2xl bg-indigo-50/50 border border-indigo-100 space-y-3 animate-in fade-in duration-200">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder="Tag name (e.g. Philosophical, Iconic)"
        ...
        <div className="px-6 py-4 border-t border-gray-100 bg-gray-50 flex items-center justify-end gap-3">
          ...
          <button
            ...
            disabled={submitting || !sentenceText.trim()}
...
export default function AddSentenceModal({
  ...
  return (
    <AddSentenceContent
      key={`${mediaType}-${mediaName}-${pageNo || 1}`}
      mediaType={mediaType}
      mediaName={mediaName}
      pageNo={pageNo}
      onClose={onClose}
